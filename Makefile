# This Makefile is for the BerkeleyDB::Lite extension to perl.
#
...
#	ABSTRACT_FROM => q[Lite.pm]
#	AUTHOR => q[Jim Schueler <jschueler@tqis.com>]
#	NAME => q[BerkeleyDB::Lite]
#	PREREQ_PM => { Storable=>q[0], BerkeleyDB=>q[0] }
#	VERSION_FROM => q[Lite.pm]
...
DISTNAME = BerkeleyDB-Lite
NAME_SYM = BerkeleyDB_Lite
VERSION = 0.04
VERSION_SYM = 0_04
XS_VERSION = 0.04
INST_BIN = blib/bin
...
FULLEXT = BerkeleyDB/Lite
BASEEXT = Lite
PARENT_NAME = BerkeleyDB
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/BerkeleyDB
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/BerkeleyDB
...
manifypods : pure_all Lite.pm
	@$(POD2MAN) \
	Lite.pm \
	$(INST_MAN3DIR)/BerkeleyDB::Lite.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"BerkeleyDB-Lite\" VERSION=\"0,04,0,0\">\n}. qq{\t<TITLE>BerkeleyDB-Lite</TITLE>\n}. qq{\t<ABSTRACT>Simplified Interface to BerkeleyDB</ABSTRACT>\n}. qq{\t<AUTHOR>Jim Schueler &lt;jschueler\@tqis.com&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"BerkeleyDB\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Storable\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i686-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > BerkeleyDB-Lite.ppd
